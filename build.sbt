lazy val scalaVersions = Seq("3.3.7")
...
val V = new {
  ...
  val julToSlf4j = "2.0.18"
  val log4Cats = "2.8.0"
  val logbackClassic = "1.5.32"
  val munitCatsEffect = "2.2.0"
  val otel4s = "0.16.0"
  val otel4sExperimental = "0.10.0"
  val otel4sSdk = "0.18.0"
  val otelAutoconfigure = "1.61.0"
  val otelIncubator = "1.59.0-alpha"
  val otelLogback = "2.25.0-alpha"
  val otelOtlp = "1.61.0"
  val otelRuntime = "2.25.0-alpha"
  val proxyVole = "2.0.0"
...
lazy val core = projectMatrix.in(file("modules/core"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.typelevel" %%% "otel4s-sdk-contrib-metrics" % V.otel4sSdk,
    ),
  )
