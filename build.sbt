lazy val scalaVersions = Seq("3.3.6")
...
val V = new {
  ...
  val otelAutoconfigure = "1.53.0"
  val otelIncubator = "1.51.0-alpha"
  val otelLogback = "2.17.1-alpha"
  val otelOtlp = "1.53.0"
  val otelRuntime = "2.17.1-alpha"
  val proxyVole = "1.1.6"
