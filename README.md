...
libraryDependencies ++= Seq(
  "de.lhns" %% "scala-common-core" % "0.6.1",
  "de.lhns" %% "scala-common-app" % "0.6.1",
  "de.lhns" %% "scala-common-http-client" % "0.6.1",
  "de.lhns" %% "scala-common-http-server" % "0.6.1",
  "de.lhns" %% "scala-common-skunk" % "0.6.1"
)
```
