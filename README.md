...
libraryDependencies ++= Seq(
  "de.lhns" %% "scala-common-core" % "0.13.2",
  "de.lhns" %% "scala-common-app" % "0.13.2",
  "de.lhns" %% "scala-common-http-client" % "0.13.2",
  "de.lhns" %% "scala-common-http-server" % "0.13.2",
  "de.lhns" %% "scala-common-skunk" % "0.13.2"
)
```
